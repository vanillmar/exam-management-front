...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between px-4 py-2 bg-black/50 backdrop-blur border-b border-white/6">
      <Link href="/dashboard" className="flex items-center gap-2.5 font-bold tracking-wide text-white">
        <Image src="/logo.png" alt="Logo" width={34} height={34} className="rounded-lg bg-white/5 p-1" />
